...
sudo git clone https://github.com/Trust-Code/trustcode-addons.git --branch 11.0 /opt/odoo/modulos/backend
...
[Unit]
Description= Sdoo - a Stainen System
Documentation=http://www.sdoo.com.br/
Contact=contato@sdoo.com.br
[Service]
# Ubuntu:
Type=simple
User=odoo
